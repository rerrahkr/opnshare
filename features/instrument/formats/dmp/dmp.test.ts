...
import { load, save } from "./dmp";

describe(".dmp file handler", () => {
  ...
  it("should handle a .dmp file", async () => {
    const dmpPath = path.resolve(__dirname, "./test.dmp");
    const buffer = (await fs.readFile(dmpPath)).buffer;
