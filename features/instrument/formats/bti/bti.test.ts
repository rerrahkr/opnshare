...
import { load, save } from "./bti";

describe(".bti file handler", () => {
  ...
  it("should handle a .bti file", async () => {
    const btiPath = path.resolve(__dirname, "./test.bti");
    const buffer = (await fs.readFile(btiPath)).buffer;
