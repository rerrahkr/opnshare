  ...
  var grammar = {
    ...
    ParserRules: [
      ...
      },
      {
        ...
        symbols: [
          lexer.has("line_head") ? { type: "line_head" } : line_head,
          "operator_line$ebnf$1",
          "operator_params",
          "operator_line$ebnf$2",
          "operator_line$ebnf$3",
        ],
        postprocess: (d) => {
